...
import {RESTART_GAME, MAKE_GUESS, GENERATE_AURAL_UPDATE, restartGame, generateAuralUpdate} from './actions';
...
describe('Reducer', () => {
    ...
    it('Can generate aural updates', () => {
        ...
        expect(state.auralStatus).toEqual(
            "Here's the status of the game right now: You're Warm. You've made 3 guesses. In order of most- to least-recent, they are: 92, 3, 25"
        );
    });
});